...
* 参数1：预返回的值，调用时无需提供
*/
STDMETHODIMP CWeChatRobot::CStartRobotService(DWORD* __result) {
...
* 参数2：预返回的值，调用时无需提供
*/
STDMETHODIMP CWeChatRobot::CStartRobotServiceByWxPid(DWORD wxPid, int* __result)
{
	*__result = StartRobotServiceByWxPid(wxPid);
	return S_OK;
}
...
* 参数2：预返回的值，调用时无需提供
*/
STDMETHODIMP CWeChatRobot::CStopRobotServiceByWxPid(DWORD wxPid, int* __result)
{
	*__result = StopRobotServiceByWxPid(wxPid);
	return S_OK;
}
